...
DROP TABLE TKK_USER;
DROP TABLE TKK_COMMENT;
DROP TABLE TKK_ATTACH;


/* 20220105 컬럼 추가 및 컬럼 명 수정 */ 
...
(
	...
	USER_ADRES 		VARCHAR(255) COMMENT '주소',
	USER_PW_FAILED  INT(1) DEFAULT 0 NOT NULL COMMENT '비밀번호 틀린 횟수',
	USER_ROLE 		VARCHAR(1) DEFAULT 'U' NOT NULL COMMENT '권한 (A : 관리자, U : 일반유저)',
	USER_STATE 		VARCHAR(1) DEFAULT 'Y' NOT NULL COMMENT '회원 상태 (Y : 정상, N : 비정상)',
...
(
ATTACH_NO 		INT NOT NULL AUTO_INCREMENT COMMENT '첨부파일 번호',
...
INSERT INTO TKK_USER VALUES ('1', 'admin', 'fa585d89c851dd338a70dcf535aa2a92fee7836dd6aff1226583e88e0996293f16bc009c652826e0fc5c706695a03cddce372f139eff4d13959da6f1f5d3eabe', '석류맛쿠키', '관리자', 'test@naver.com', '010-1234-1234', '인천광역시', 0, 'A', 'Y', sysdate(), sysdate());
